...
var projectName = "DotNet.Polly.Contrib.RateLimiting";
    ...
    .Does(() =>
{
    ...
    appveyorBuildNumber = gitVersionOutput["BranchName"].ToString().Equals("main", StringComparison.OrdinalIgnoreCase)
